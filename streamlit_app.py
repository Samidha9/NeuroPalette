...
# Streamlit interface
st.title("🎨 Neural Style Transfer (Optimized for Speed)")
st.write("Upload a content image and a style image to generate a stylized result in ~1 minute.")
...
if st.button("Generate Stylized Image") and content_file and style_file:
    ...
    with st.spinner("Stylizing... please wait (~1 min)"):
